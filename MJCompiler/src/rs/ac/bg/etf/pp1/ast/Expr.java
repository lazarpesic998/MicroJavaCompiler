...
public class Expr implements SyntaxNode {
    ...
    private int line;
    private MinusPrefix MinusPrefix;
    private Term Term;
    private AddopTermList AddopTermList;

    public Expr (MinusPrefix MinusPrefix, Term Term, AddopTermList AddopTermList) {
        this.MinusPrefix=MinusPrefix;
        if(MinusPrefix!=null) MinusPrefix.setParent(this);
        this.Term=Term;
    ...
    public MinusPrefix getMinusPrefix() {
        return MinusPrefix;
    }

    public void setMinusPrefix(MinusPrefix MinusPrefix) {
        this.MinusPrefix=MinusPrefix;
    }
    ...
    public void childrenAccept(Visitor visitor) {
        if(MinusPrefix!=null) MinusPrefix.accept(visitor);
    ...
    public void traverseTopDown(Visitor visitor) {
        accept(visitor);
        if(MinusPrefix!=null) MinusPrefix.traverseTopDown(visitor);
        if(Term!=null) Term.traverseTopDown(visitor);
        if(AddopTermList!=null) AddopTermList.traverseTopDown(visitor);
    }

    public void traverseBottomUp(Visitor visitor) {
        if(MinusPrefix!=null) MinusPrefix.traverseBottomUp(visitor);
    ...
    public String toString(String tab) {
        ...
        if(MinusPrefix!=null)
            buffer.append(MinusPrefix.toString("  "+tab));
        else
